...
func (*Certificate) scanValues(columns []string) ([]interface{}, error) {
...
func (c *Certificate) assignValues(columns []string, values []interface{}) error {
...
func (c *Certificate) QueryDomains() *DomainQuery {
	return (&CertificateClient{config: c.config}).QueryDomains(c)
}
