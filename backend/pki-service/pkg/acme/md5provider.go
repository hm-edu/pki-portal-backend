...
import (
	"crypto/hmac"
	// Required due to the use in legacy zones
	"crypto/md5" //#nosec
	"encoding/base64"
	"encoding/hex"
...
// md5provider implements the dns.TsigProvider interface for hmac-md5 signed
// messages since the dns library dropped the built-in support.
